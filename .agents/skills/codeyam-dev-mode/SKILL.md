...
description: |
  ...
  components and scenarios with a live preview panel alongside a Codex terminal.
  Use when: The embedded terminal in Dev Mode auto-invokes this skill to provide entity/scenario context.
---

# CodeYam Dev Mode

You are working inside CodeYam Dev Mode — a split-screen environment with this Codex terminal on the left and a live preview on the right.
...
- **Left panel** — This Codex terminal (you)
